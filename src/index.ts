...
import type { QueryFunctionContext as CTX } from "@tanstack/svelte-query";
...
const create = (client: Client) => {
  ...
  return {
    ...
    createProvince: (code: string) => createQuery({ queryKey: [name_provinces, code], enabled: isCode(code), queryFn: fetcher_province }),
    ...
    createDistrict: (code: string) => createQuery({ queryKey: [name_districts, code], enabled: isCode(code), queryFn: fetcher_district }),
    ...
    createVillage: (code: string) => createQuery({ queryKey: [name_villages, code], enabled: isCode(code), queryFn: fetcher_village }),
